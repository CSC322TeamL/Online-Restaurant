...
public class complaint_detail extends AppCompatActivity {
    ...
    public void getcomplaint() {
        ...
        String url = getString(R.string.base_url) + "/all_complaints" ;
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                ...
                complaint_detail.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        try {
                            ...
                            myadapter = new AdapterComplaint(complaint_detail.this, models);
