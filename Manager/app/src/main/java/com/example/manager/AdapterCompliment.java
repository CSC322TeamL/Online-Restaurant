...
public class AdapterCompliment extends RecyclerView.Adapter<complaint_viewholder> {


    Context c;
    ArrayList<model> lmodel;

    public AdapterCompliment(Context c, ArrayList<model> lmodel) {
        this.c = c;
        this.lmodel = lmodel;
    }
    ...
    public void onBindViewHolder(@NonNull complaint_viewholder holder, int i) {
        ...
        String complimentid = (lmodel.get(i).getCaseid());
        holder.btn_accept.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bodyBuilder.add("complaintID", complimentid);
