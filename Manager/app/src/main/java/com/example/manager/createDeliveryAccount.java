...
public class createDeliveryAccount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_delivery_account);
        ...
        _submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(cf_firstname.equals("")){
                    Toast.makeText(createDeliveryAccount.this,"The first name cannot be empty", Toast.LENGTH_SHORT).show();
                }
                else if(cf_lastname.equals("")){
                    Toast.makeText(createDeliveryAccount.this,"The Last name cannot be empty", Toast.LENGTH_SHORT).show();
                }
                else if(cf_gender.equals("")){
                    Toast.makeText(createDeliveryAccount.this,"The gender cannot be empty", Toast.LENGTH_SHORT).show();
                }
                else if(cf_email.equals("")){
                    Toast.makeText(createDeliveryAccount.this,"The email cannot be empty", Toast.LENGTH_SHORT).show();
                }
                else if(cf_phone.equals("")){
                    Toast.makeText(createDeliveryAccount.this,"The phone number cannot be empty", Toast.LENGTH_SHORT).show();
                }
                else if(cf_street.equals("")){
                    Toast.makeText(createDeliveryAccount.this,"The street cannot be empty", Toast.LENGTH_SHORT).show();
                }
                else if(cf_city.equals("")){
                    Toast.makeText(createDeliveryAccount.this,"The city cannot be empty", Toast.LENGTH_SHORT).show();
                }
                else if(cf_state.equals("")){
                    Toast.makeText(createDeliveryAccount.this,"The state cannot be empty", Toast.LENGTH_SHORT).show();
                }
                else if(cf_zip.equals("")){
                    Toast.makeText(createDeliveryAccount.this,"The zip code cannot be empty", Toast.LENGTH_SHORT).show();
                }
                else if(cf_hourlyrate.equals("")){
                    Toast.makeText(createDeliveryAccount.this,"The hourlyrate cannot be empty", Toast.LENGTH_SHORT).show();
                }
                else if(cf_userid.equals("")){
                    Toast.makeText(createDeliveryAccount.this,"The useer ID cannot be empty", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    client.newCall(request).enqueue(new Callback() {
                        ...
                        public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                            ...
                            createDeliveryAccount.this.runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    try {
                                        ...
                                        if(code.equals("0")){
                                            Toast.makeText(createDeliveryAccount.this,context,Toast.LENGTH_SHORT).show();
